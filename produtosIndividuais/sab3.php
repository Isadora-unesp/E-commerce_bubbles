...
<head>
    ...
    <title>Sabonete Mirtilo | Fruit Bubbles</title>
            ...
            <div class="slideshow-coluna">
                ...
                <div class="slideshow">
                    ...
                    <div class="slide ativo">
                        ...
                        <img src="../img/mirtilo.jpg" alt="Sabonete Mirtilo, foto 1">
                    </div>

                    <div class="slide">
                        <span class="slide-contador">2 / 3</span>
                        <img src="../img/mirtilo.jpg" alt="Sabonete Mirtilo, foto 2">
                    </div>

                    <div class="slide">
                        <span class="slide-contador">3 / 3</span>
                        <img src="../img/mirtilo.jpg" alt="Sabonete Mirtilo, foto 3">
                    </div>
